...
const Footer = () => {
  ...
  return (
    <>
      <footer css={tw`md:w-9/12 md:mx-auto mt-3 flex-shrink-0 flex flex-no-wrap justify-around`}>
      ...
      <p css={tw`text-xs mx-auto text-gray-400 mb-1`}>Developed by Martin Sesto, psst still under development</p>
    </>
  )
}
